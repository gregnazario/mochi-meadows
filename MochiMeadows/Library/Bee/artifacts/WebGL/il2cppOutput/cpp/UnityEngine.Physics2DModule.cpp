...
FINALLY_0054:
		...
		try
		{
			...
			}
			{
				...
				uintptr_t L_9 = (il2cpp_codegen_conv<uintptr_t,RaycastHit2D_t3EAAA06E6603C6BC61AC1291DD881C5C1E23BDFA*,intptr_t,false,false>(((L_8)->GetAddressAtUnchecked(static_cast<il2cpp_array_size_t>(0))),NULL));
